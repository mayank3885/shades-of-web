const arabian = require("./assets/arabian.jpg");
const arabianTwo = require("./assets/arabian2.jpg");
const downtownDubai = require("./assets/downtown-dubai.jpg");
const dubaiHillEstate = require("./assets/dubai-hills-estate.jpg");
const dubaiMarina = require("./assets/dubai-marina.png");
const emiratesLiving = require("./assets/emirates-living.jpg");
